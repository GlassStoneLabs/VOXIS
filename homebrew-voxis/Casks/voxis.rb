cask "voxis" do
  ...
  url "https://github.com/GlassStoneLabs/VOXIS/releases/download/v#{version}/Voxis.4.0.DENSE-#{version}-arm64.dmg"
  name "Voxis 4.0 DENSE"
  ...
  app "Voxis 4.0 DENSE.app"

  zap trash: [
    "~/Library/Application Support/Voxis 4.0 DENSE",
  ...
  caveats <<~EOS
    Voxis 4.0 DENSE requires FFmpeg for audio decoding:
      brew install ffmpeg
